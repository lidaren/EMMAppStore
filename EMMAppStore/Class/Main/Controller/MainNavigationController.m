...
//  精选速购商城
//
//  Created by YanHui Lee on 2016/10/22.
...
//        [backButton setImage:[UIImage imageNamed:@"icon_arrow_left"] forState:UIControlStateHighlighted];
...
- (void)didReceiveMemoryWarning {
    ...
    YHLog(@"MainNavigationController内存已经满了");
}
