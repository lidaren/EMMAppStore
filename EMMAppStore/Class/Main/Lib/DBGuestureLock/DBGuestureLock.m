...
//    DBGuestureLock *lock = [[DBGuestureLock alloc] initWithFrame:frame];
    ...
    CGFloat h = win.size.height;
    CGFloat w = win.size.width;
    CGRect frame = CGRectMake(0, h/3-50, w, w);
    DBGuestureLock *lock = [[DBGuestureLock alloc] initWithFrame:frame];
...
-(void)setPropertiesByState:(DBButtonState)buttonState {
    switch (buttonState) {
        case DBButtonStateNormal:
            ...
            //As default    默认状态下按钮的颜色 62 167 248
            self.strokeColor = [UIColor colorWithRed:62/255.0 green:167/255.0 blue:248/255.0 alpha:1];
            if (self.delegate) {
        ...
        case DBButtonStateSelected:
            ...
            self.lineColor = [UIColor colorWithRed:248/255.0 green:55/255.0 blue:83/255.0 alpha:1];
            if (self.delegate) {
                if ([self.delegate respondsToSelector:@selector(lineColorOfGuestureOnState:)]) {
            ...
            //As default
            self.strokeColor = [UIColor colorWithRed:248/255.0 green:55/255.0 blue:83/255.0 alpha:1];
            if (self.delegate) {
                if ([self.delegate respondsToSelector:@selector(colorOfButtonCircleStrokeOnState:)]) {
            ...
            //As default      248 55 83
            self.centerPointColor = [UIColor colorWithRed:248/255.0 green:55/255.0 blue:83/255.0 alpha:1];
            if (self.delegate) {
                if ([self.delegate respondsToSelector:@selector(colorOfButtonCircleCenterPointOnState:)]) {
