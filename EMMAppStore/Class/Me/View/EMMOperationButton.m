...
@implementation EMMOperationButton
      ...
      withIconImage:(NSString *)imageString
{
    ...
    if (self) {
        ...
        // 图片icon
        UIImageView * imageIcon = [[UIImageView alloc]initWithFrame:CGRectMake(self.frame.size.width/2-23, 25, 46, 46)];
...
//响应格子点击事件
- (void)gridClick:(EMMOperationButton *)clickItem
{
